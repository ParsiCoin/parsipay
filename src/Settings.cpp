...
void Settings::load() {
  ...
  defaultPoolList << "pool.parsicoin.net:51101" << "pars.hashpool.frl:11333";
  ...
  defaultNodesList << "eu-node.parsicoin.net:18230"; << "us-node.parsicoin.net:18230"; 
...
QString Settings::getCurrentRemoteNode() const {
    ...
    if (m_settings.contains(OPTION_REMOTE_NODE)) {
		...
		remotenode = "node.parsicoin.net:18230";
    }
    return remotenode;
}
